...
An sad c "It doesn’t matter anyway, he won’t find us out here. It’s too dark."
c "Well, you've pretty much already broadcasted our location to him with that fire."
An face c "…"
An normal c "You know what? You’re right. Since he already knows where we are, let's just start shouting for him to come and get us."
An disgust c "{size=+5}Hey! We’re stealing your mouflon! Come and get us!{/size}"
c "Anna!" with vpunch
An smirk c "Aww… Are you scared of the scary dragon coming to get us? Boo-hoo, so sad…"
An normal c "Seriously, [player_name], he-{w=0.5}{nw}"
"???" "{size=+5}HEY! WHAT IN THE HELL ARE YOU TWO DOIN' OM MY FARM?!{/size}" with vpunch
An face c "Dammit…"
$ renpy.pause (0.5)
...
c "You’re the one who started yelling!"
An sad c flip "…"
c "…"
$ renpy.pause (1.5)
if anna2mood < 1:
...
$ renpy.pause (1.5)
c "Actually, I was wondering, how did you find out about this farm?"
show anna normal c with dissolve
An "Well, a while ago when I was coming back from a vacation, it was pretty late and I was peckish. Then I just happened to subtle across the farm."
c "And you asked the owner of the farm politely if they had leftovers they could spare?"
An "Nope."
An smirk c "I helped myself to some delicious mouflon steaks."
c "Sounds like you enjoyed it."
An "I definitely did. You never forget your first freshly-killed meal."
An normal c "You’d be surprised how easy it is. It’s almost like the farmer’s asking for it. I’m amazed how there are any mouflons still left in the field."
An "They’re basically free. You could just take one home for a quick fresh meal whenever you wanted."
c "The poor farmer… He won’t stay in business for long with people like you."
An "More like the poor mouflons. They wouldn’t be getting turned into mincemeat, kebabs, and who knows what else if they were taken care of properly."
$ renpy.pause (1.5)
...
$ renpy.pause (1.5)
"???" "{size=+5}HEY! YOU CURSED HOOLIGANS! GET BACK HERE NOW!{/size}" with vpunch
...
An normal c "I only do stuff like this very occasionally, and I’d only do something insignificant or inconsequential. Like, killing a single mouflon, or burning an old run-down shed full of rusty tools."
