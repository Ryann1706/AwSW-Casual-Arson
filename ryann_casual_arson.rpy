...
An face c "What?"
c "I mean, you’re acting like he’s actually a threat, or he’s dangerous to us, or something."
...
An "Well, as I said, my fire is made from the two different components combining. And my body can’t produce enough to lite the entire shed"
...
menu:
    "[[Pet it.]":
        ...
        if anna2mood > 1:
            ...
            c "It’s so fluffy…"
            An normal c "Yes. It’s a farm animal. Meaning it’s raired for the specific animal products it produces, so they can be later harvested."
...
Sb "Sure thing, Chief. But there’s one other thing I was informed about."
Br "What is it?"
...
Sb "The victim is the owner of a farm and reported seeing the silhouettes of two people, one being a runner. But they said it was too dark to see any more details, or clearly see the silhouette of the other."
